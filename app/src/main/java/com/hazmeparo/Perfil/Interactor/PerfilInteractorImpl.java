package com.hazmeparo.Perfil.Interactor;
...
public class PerfilInteractorImpl implements PerfilInteractor {
    ...
    public PerfilInteractorImpl(PerfilPresenter presenter, PrefsManager manager) {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    presenter.setDatos(user.getFirstName() + " " + user.getLastName(),
                            user.getUsuario().getCalificacion_compi(), user.getUsername(), user.getEmail(),
    ...
    public void getOpiniones(String username) {
        Call<List<Calificacion>> call = api.getOpinionesUsuario("/a/calif_usuario_list/?usuario="+username+"&compi=true", "Token " + manager.obtenerValorString("token"));
